...
export const Icon247 = ({ style }: { style?: CSSProperties }) => {
    ...
    return (
        <svg viewBox="0 0 103.99835 74.620003" style={{ fill: color, ...style }}>
            <g transform="matrix(0.01,0,0,0.01,-50.71365,-38.243853)">
                ...
                <g style={{ clipRule: 'evenodd', fillRule: 'evenodd', shapeRendering: 'geometricPrecision', textRendering: 'geometricPrecision' }}
                    transform="translate(-228.63455,-7294.6145)">
                    <g>
                        <path
